...
import z from 'zod';
import { PresetHintContainerSchema, PresetSchema, PresetSectionSchema } from '../../shared/preset.types';
import { HintContainerSchema, HintLayoutSchema, HintSchema, HintSectionSchema } from './hint-layout.types';

const PresetToLayoutHintContainerTransformSchema = PresetHintContainerSchema.transform((presetContainer) => {
...
const PresetToLayoutHintSectionSchema = PresetSectionSchema.transform((section) => {
  return HintSectionSchema.parse({
    ...section,
    content: z.array(PresetToLayoutHintContainerTransformSchema).parse(section.content),
  });
});
